...
export const Film: FC<FilmProps> = ({title, vote_average, poster_path, release_date, id}) => {
  ...
  return (
    ...
    >
      <img src={poster_path ? `https://image.tmdb.org/t/p/w300${poster_path}` : noPoster} alt="poster"/>
      <CardBg 
        initial={
          { height: 0}
        }
