...
import { TOP_RATED_FILMS_FAIL, TOP_RATED_FILMS_LOADING, TOP_RATED_FILMS_SUCCESS } from "./TopRatedFilmsActionTypes";

const api_key = '6650890bc34e6b3eeefaf36590d2a82c'

export const GetTopRatedFilms = (page: number = 1) => async (dispatch: Dispatch) => {
  try {
    dispatch({
