  ...
  return (
    <div className="App">
      ...
      <Switch>
        ...
        <Route path={'/film/:filmId/:pageNumber'} exact component={FilmPage}></Route>
        <Route path={'/tv/:tvId'} exact component={FilmPage}></Route>
        <Route path={'/popular/:pageNumber'} exact component={Home}></Route>
        <Route path={'/top_rated/:pageNumber'} exact component={TopRated} />
        <Route path={'/trending_films/:pageNumber'} exact component={TrendingFilms} />
        <Route path={'/trending_people/:pageNumber'} exact component={TrendingPeople} />
        <Route path={'/trending_tvs/:pageNumber'} exact component={TrendingTV} />
