...
export const TopRated = () => {
  ...
  const topRatedFilms = useSelector((state: RootStore) => state.topRatedFilms.topRated)
  const currentPage = useSelector((state: RootStore) => state.topRatedFilms.topRated?.page)
  const totalPages = useSelector((state: RootStore) => state.topRatedFilms.topRated?.total_pages)
